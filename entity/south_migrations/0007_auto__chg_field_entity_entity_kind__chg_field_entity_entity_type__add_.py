...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'entity_entity', 'entity_kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity.EntityKind'], on_delete=models.PROTECT))

        # Changing field 'Entity.entity_type'
        db.alter_column(u'entity_entity', 'entity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], on_delete=models.PROTECT))
        # Adding field 'EntityKind.is_active'
        db.add_column(u'entity_entitykind', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entity.entity_kind'
        db.alter_column(u'entity_entity', 'entity_kind_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity.EntityKind']))

        # Changing field 'Entity.entity_type'
        db.alter_column(u'entity_entity', 'entity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
        # Deleting field 'EntityKind.is_active'
        db.delete_column(u'entity_entitykind', 'is_active')
