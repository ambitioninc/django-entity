...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entity.entity_tag'
        db.alter_column(u'entity_entity', 'entity_tag_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['entity.EntityTag']))

    def backwards(self, orm):

        # Changing field 'Entity.entity_tag'
        db.alter_column(u'entity_entity', 'entity_tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity.EntityTag'], null=True))
    ...
    models = {
        ...
        u'entity.entity': {
            ...
            'entity_tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entity.EntityTag']"}),
